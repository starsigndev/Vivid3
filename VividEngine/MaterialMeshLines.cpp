...
MaterialMeshLines::MaterialMeshLines() {
...
void MaterialMeshLines::Create() {
    ...
    BasicUniform = CreateUniform(sizeof(LinesConstants), "Constants Uniform Buffer - MVP");
    ...
    rl_desc.Variables = nullptr;// vars.data();
    rl_desc.ImmutableSamplers = nullptr;//. samplers.data();
...
void MaterialMeshLines::Bind(bool sp) {
    ...
    MapHelper<LinesConstants> map_data(Engine::m_pImmediateContext, BasicUniform, MAP_WRITE, MAP_FLAG_DISCARD);
