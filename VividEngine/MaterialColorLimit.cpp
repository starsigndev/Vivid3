...
MaterialColorLimit::MaterialColorLimit() {

    Create();

}

void MaterialColorLimit::Create() {

    //.\n");
    SetVertexShader("pp_ColorLimit.vsh");
    SetPixelShader("pp_ColorLimit.psh");
...
void MaterialColorLimit::Bind(bool sp) {
...
//    auto light = Engine::m_Lights[0];
    ...
    map_data[0].v_Limits = float4(m_ColorLimit, 0, 0, 0);
